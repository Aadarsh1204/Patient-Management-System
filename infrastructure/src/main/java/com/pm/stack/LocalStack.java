...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "aHVycnlyZWNlbnRseWF0dGFja3VuaW9ucGFpbnRsYXJnZXN1cHBvcnR0ZXN0cmVhcnI="));
   ...
   private Cluster createEcsCluster(){
        return Cluster.Builder.create(this, "PatientManagamentCluster")
                .vpc(vpc)
    ...
    private FargateService createFargateService(String id,
        ...
        if(db != null) {
            ...
            envVars.put("SPRING_JPS_HIBERNATE_DDL_AUTO", "update");
