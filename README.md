...
rectangle "Docker Network / Service Runtime" {

    rectangle "API Gateway\nSpring Cloud Gateway\nlocalhost:4004" as gateway

    rectangle "Auth Service\nJWT Login + Validation\nlocalhost:4005" as auth
    database "Auth DB" as authDb

    rectangle "Patient Service\nREST CRUD\nlocalhost:4000" as patient
    database "Patient DB" as patientDb

    rectangle "Billing Service\ngRPC Server\nlocalhost:9001" as billing

    rectangle "billing_service.proto\ngRPC Contract" as proto

    rectangle "Kafka" as kafka
    rectangle "Analytics Service\nKafka Consumer" as analytics

    ' ===== Layout Stabilizers =====
    gateway -[hidden]-> auth
    auth -[hidden]-> patient
    patient -[hidden]-> billing
    billing -[hidden]-> kafka
    kafka -[hidden]-> analytics
}

rectangle "Infrastructure\nAWS CDK + LocalStack" as infra

' =========================
' Client Flow
' =========================

Client --> gateway : REST Requests

gateway --> auth : /auth/**
gateway --> patient : /api/patients/**
...
patient --> billing : gRPC Call

proto -[hidden]down-> billing
patient ..> proto : Uses
proto ..> billing : Defines

' =========================
' Kafka
' =========================

patient --> kafka : Publish Event
